...
const BookNowForm = dynamic(() => import('app/booking-engine-widget/BookNowForm'));

const styles = dynamic(() => import('../../app/styles/inner.css'), { ssr: true });
const contactStyles = dynamic(() => import('../../app/styles/contactus.css'), { ssr: true });
