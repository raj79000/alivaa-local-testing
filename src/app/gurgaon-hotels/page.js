                                    ...
                                    <div className="tab-pane fade show active overview-alivaa-offer-slider" id="all" role="tabpanel">
                                        ...
                                        <Swiper
                                            ...
                                            <div className="swiper-wrapper justify-content-center" >
                                                <SwiperSlide>
                                                    <img src="/offers/day-use-offer-alivaa-ggn1.jpg" className="img-fluid w-100 w-100 img2" alt="Alivaa Images" />
                                                ...
                                                <SwiperSlide>
                                                    <img src="/offers/limited-time-offer-alivaa-ggn1.png" className="img-fluid w-100 w-100 img2" alt="Alivaa Images" />
                                                    <div className="text-center">
                                                        <div className="offers-text-home">
