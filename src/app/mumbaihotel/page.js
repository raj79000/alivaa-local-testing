...
<header className="clearHeader bg-green proprty-hdr">
    ...
    <img alt="Hotels in Mumbai" className="banner-img hght100vh pt-0 mb-5" src="/mumbai-img/mumbai-c-soon.jpg" />
    <div className="mt-5 position-absolute">

<h1 className="main-hero-title coming-hero-title">Stay tuned, Mumbai! </h1>
