...
const Properties = (id) => {
    console.log(id);
  const { setSelectedPropertyId, setSelectedPropertyName, setSelectedPropertyPhone, setFilteredRooms,selectedRoom, setSelectedRoom, setSelectedRoomRate, setPropertyId, setCancellationPolicyState } = useBookingEngineContext();
...
console.log(selectedRoom);
  ...
  return (
    <>
      ...
      <section className={`booking-form-wrapper toggle-div visible`}>
        <div className="container-fluid">
          <div id="booking-bar" className={`booking-bar fullscreen`}>
                                            ...
                                            <div className="book-a-stay d-flex justify-content-end">
                                              <button
                                                ...
                                                onClick={() => {
                                                 ...
                                                 // setSelectedRoom([{ roomId: rooms.RoomId, roomName: rooms.RoomName, roomImage: rooms.Images[0] }]);
                                                  setSelectedRoom((prev) =>
                                                    prev.map((room) =>
                                                      room.id == id
                                                        ?{
                                                          ...room, roomId: rooms.RoomId, roomName: rooms.RoomName,roomRate: rooms.RackRate, roomImage: rooms.Images[0] }:room));
                                                        ...
                                                        <div>
                                                          ...
                                                          <div className="select-button book-a-stay">
                                                            {/* <button className="btn btn-primary" onClick={() => {
                                                             ...
                                                             <button className="btn btn-primary" onClick={ () => SelectedRoomWithOffer(mapping)}> 
                                                             Select </button>
