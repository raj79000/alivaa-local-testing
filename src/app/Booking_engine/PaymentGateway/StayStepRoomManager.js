...
const StayStepRoomManager = () => {
  const { selectedRooms, setSelectedRooms,selectedRoom,setSelectedRoom } = useBookingEngineContext();
    ...
    {isRoomsClose && 
        <div className="mb-3 mb-md-0">
          <div className="book-room my-0">
            ...
            <div className="row"> 
             <div className="room-manager-close-icon" onClick={closeRoomChange}> 
