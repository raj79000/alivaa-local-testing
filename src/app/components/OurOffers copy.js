...
const OurOffers = () => {
    ...
    const hoftenSwiperRef = useRef(null);
      const landowneSwiperRef = useRef(null);
    ...
    useEffect(() => {
        ...
        if (landowneSwiperRef.current) {

            new Swiper(landowneSwiperRef.current, {
            ...
            <div className="container">
                ...
                <div className="tab-content mt-3">
                        ...
                        <div className="swiper offers-slider" ref={allSwiperRef}>
                            <div className="swiper-wrapper abc">
                                <div className="swiper-slide">
                                    <Image height={300} width={300} src="/offers/day-use-offer-alivaa-ggn1.jpg" className="img-fluid" alt="Alivaa Images" />
                                    <div className="text-center">
                                        <div className="offers-text-home">
                                            <h4 className="offer-name mt-3"> Day Use Rooms</h4>
                                ...
                                <div className="swiper-slide">
                                    <Image height={300} width={300} src="/offers/limited-time-offer-alivaa-lns1.png" className="img-fluid" alt="Alivaa Images" />
                                    <div className="text-center">
                                        <div className="offers-text-home">
                                            <h4 className="offer-name mt-3"> Limited Time Offer</h4>
                                            <p className="offer-description" style={{ fontSize: "14px", color: "#3b3b3b", fontFamily: 'VERDANA' }}>
                                ...
                                <div className="swiper-slide">
                                    <Image height={300} width={300} src="/offers/limited-time-offer-alivaa-mc1.png" className="img-fluid" alt="Alivaa Images" />
                                    <div className="text-center">
                                        <div className="offers-text-home">
                                            <h4 className="offer-name mt-3"> Limited Time Offer</h4>
                                            <p className="offer-description" style={{ fontSize: "14px", color: "#3b3b3b", fontFamily: 'VERDANA' }}>
                                        ...
                                        <Link href="/mcleodganj-hotel-offers" className="btn btn-primary voffset-2 cls-relax-offer">View Offer</Link>
                                    </div>
                                </div>
                                <div className="swiper-slide">
                                    <Image height={300} width={300} src="/offers/limited-time-offer-alivaa-ggn1.png" className="img-fluid" alt="Alivaa Images" />
                                    <div className="text-center">
                                        <div className="offers-text-home">
                                            <h4 className="offer-name mt-3"> Limited Time Offer</h4>
                                            <p className="offer-description" style={{ fontSize: "14px", color: "#3b3b3b", fontFamily: 'VERDANA' }}>
                    ...
                    <div className="tab-pane fade" id="lansdowne" role="tabpanel" style={{ textAlign: "center" }}>
                        {/* <Image height={300} width={300} src="/images/comingsoon.png" className="search-iconimage" alt="Search Icon" /> */}
                         <div className="swiper offers-slider" ref={landowneSwiperRef}>
                            <div className="swiper-wrapper abc">
                                <div className="swiper-slide">
                                    <Image height={300} width={300} src="/offers/limited-time-offer-alivaa-lns1.png" className="img-fluid" alt="Alivaa Images" />
                                    <div className="text-center">
