          ...
          <div className="row text-center verticalTop" style={{ marginLeft: "5px" }}>
            <motion.div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeInLeft animated" data-wow-duration="4s"
              ...
              <p style={{ fontSize: "14px", color: "#000" }}>
                <a href="https://maps.app.goo.gl/orkJgoWfuofAUEtn9" target="_blank"> Jawai Palash Resort Near C.P. Nadi, Jeevda Village, Sena Tehsil, Bali District, Pali, Rajasthan - 303707
              </a></p>
            </motion.div>
            <motion.div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeInDown animated" data-wow-duration="4s"
              ...
              <p style={{ fontSize: "14px", color: "#00a3e0" }}><a href="tel:+917827898967">+91 78278 98967</a></p>
            </motion.div>
            <motion.div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 wow fadeInRight animated" data-wow-duration="4s"
              ...
              <p style={{ fontSize: "14px", color: "#00a3e0" }}><a href="mailto:dirsales.ggnl@alivaahotels.com">dirsales.ggnl@alivaahotels.com</a></p>
            </motion.div>
          </div>
        </div>
      </motion.div>
          ...
          <motion.div className="row mb-5"
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 wow fadeInRight animated" data-wow-duration="4s" >
              <div className="row" >
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d462524.3528915599!2d72.86823691554198!3d25.08589568916711!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x394297d19c4cd45f%3A0xaa013253b255bc62!2sJawai%20Palash%20Resort!5e0!3m2!1sen!2sin!4v1750405762000!5m2!1sen!2sin" width="100%" height="350" ></iframe>
              </div>
            </div>
          </motion.div>
        </div>
