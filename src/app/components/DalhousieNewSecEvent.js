          ...
          <div className="global-heading-sec text-start">
            <div className="row align-items-center" data-aos="fade-in" data-aos-easing="ease-in-sine">
              <div className="col-md-7">
                <Image src="/jawai-img/dine-under-the-sky.png" height={400} width={500} alt="image" className="w-100" />
              </div>
              <div className="col-md-5 space_in d-flex flex-column justify-content-center">
                <h2 className="inner-head mt-5">Under the Sky</h2>
                <p className="mb-2 text-justify" style={{ textAlign: 'justify' }}>
                  Step into our expansive open grounds, where the dining experience unfolds in harmony with nature. This dedicated space for breakfast and lunch is a true delight for the senses. Start your day with the gentle melodies of birds, soothing morning air, and invigorating aroma of freshly prepared food. It’s the perfect setting to savour delicious meals while soaking in the untouched beauty of the region.
...
export default DalhousieNewSecEvent;