...
const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    source_enquiry: 'alivaa-lansdowne-contact-us',
    ...
    return (
        ...
        <div className="row text-center verticalTop" style={{ marginLeft: "5px"}}>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px",color:"#000"}}><a href="#" target="_blank"> Palkot P. O, Lansdowne, Uttarakhand 246169
</a></p>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px",color:"#00a3e0"}}><a href="tel:7827898967">+91 782 7898967</a></p>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px",color:"#00a3e0"}}><a href="mailto:dirsales.ggn1@alivaahotels.com">dirsales.ggn1@alivaahotels.com</a></p>
        ...
        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 wow fadeInRight animated" data-wow-duration="4s" >
          ...
          <div className="row" >
            ...
            <div className="col">
			 ...
			 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3461.28052176281!2d78.69023589999999!3d29.827323600000007!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909830040252e41%3A0xb8857efd98233521!2sViceroy%20In%20the%20Himalaya%20%7C%20Lansdowne!5e0!3m2!1sen!2sin!4v1747986009687!5m2!1sen!2sin" width="100%" height="320" loading="lazy" ></iframe>
...
export default LansdowneHotelContact