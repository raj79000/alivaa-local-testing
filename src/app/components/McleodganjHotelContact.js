...
const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    source_enquiry: 'alivaa-mcleodganj-contact-us',
    ...
    return (
        ...
        <div className="row text-center verticalTop" style={{ marginLeft: "5px"}}>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px",color:"#000"}}><a href="#" target="_blank"> Alivaa Hotel
Forsyth Ganj, McLeodganj
Dharamshala Cantt, Distt Kangra HP
PIN- 176216
</a></p>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px",color:"#00a3e0"}}><a href="tel:91 782 7898967">+91 782 7898967</a></p>
...
export default McleodganjHotelContact