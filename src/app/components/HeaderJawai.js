          ...
          <nav className="navbar navbar-default navbar-static-top" role="navigation">
            ...
            <div className={`collapse navbar-collapse ${isOpen1 ? "show" : ""}`} id="navbar-collapse-1">
              <ul className="nav navbar-nav navbar-right">
                ...
                <li><Link href="/jawai-palash-resort-overview">Overview</Link></li>
                <li><Link href="/jawai-palash-resort-rooms-suites">Room & Suites</Link></li>
                <li><Link href="/jawai-palash-resort-dining">Dining</Link></li>
                <li><Link href="/jawai-palash-resort-facilities">Facilities</Link></li>
                {/* <li><Link href="/jawai-palash-resort-offers">Offers</Link></li> */}
                <li><Link href="/jawai-palash-resort-attractions">Attractions</Link></li>
                <li><Link href="/jawai-palash-resort-gallery">Gallery</Link></li>
                <li><Link href="/jawai-palash-resort-contact">Contact Us</Link></li>
              </ul>
            </div>
          </nav>
        </div>
