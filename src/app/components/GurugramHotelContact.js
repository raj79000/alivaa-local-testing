...
const GurugramHotelContact = () => {
 const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    source_enquiry: 'hoften-gurugram-contact-us',
    ...
    return (
        ...
        <div className="row text-center verticalTop" style={{ marginLeft: "5px"}}>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px", color:"#245704"}}><a href="https://maps.app.goo.gl/wUQepQG85dWxhncL7" target="_blank"> J 18, Mayfield Garden, Sector-51, Gurugram, Haryana-122018, India</a></p>
          ...
          initial={{ opacity: 0, x: -50 }}
                ...
                <p style={{fontSize: "14px", color:"#245704"}}><a href="mailto:stayalive@alivaahotels.com">dirsales.ggn1@alivaahotels.com <br/> reception@morphosukhvasa.com</a></p>
...
export default GurugramHotelContact