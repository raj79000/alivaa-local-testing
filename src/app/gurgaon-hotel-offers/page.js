...
Cancellation Policy: Non-cancellable, non-refundable and non-amendment for entire length of stay.</li>
                        ...
                        {/* <div className="row align-items-start mx-0  mb-5 my-5">
                            ...
                            <div className="col-lg-6 offset-lg-1 p-0 mb-5 text-start" id="relax-with-staycation"
