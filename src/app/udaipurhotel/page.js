...
<header className="clearHeader bg-green proprty-hdr">
    ...
    <img alt="Hotels in Udaipur" className="banner-img hght100vh pt-0 mb-5" src="/udaipur-img/udaipur-c-soon.jpg" />
    <div className="mt-5 position-absolute">

<h1 className="main-hero-title coming-hero-title">Soon in the City of Lakes</h1>
