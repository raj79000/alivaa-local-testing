 ...
 const handleCheckAvailability = () => {
  ...
  <div className="popup-overlay">
    <div className="popup-form">
      ...
      <div className="popup-field">
        <label>Name</label>
        <input type="text" value={guestInfo.name} onChange={(e) => setGuestInfo({ ...guestInfo, name: e.target.value })} required placeholder='Enter Name' />
        {guestInfo.name === '' && guestInfo.name !== undefined && guestInfo.submitted && <span style={{ color: 'red', fontSize: '12px' }}>Please enter your name</span>}
      </div>
      <div className="popup-field">
        <label>Mobile</label>
